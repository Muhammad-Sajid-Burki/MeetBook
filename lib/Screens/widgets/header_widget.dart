    ...
    return Container(
      child: Stack(
        children: [
          ...
          Center(child: Image.asset('assets/images/logo.png', color: Colors.white, height: 100, width: 100,))
          /*Visibility(
            visible: _showIcon,
            child: Container(
              height: _height - 40,
              child: Center(
                child: Container(
                  ...
                  child: Image.asset('assets/images/logo.png', color: Colors.white, height: 50, width: 50,)
                ),
              ),
            ),
          ),*/
